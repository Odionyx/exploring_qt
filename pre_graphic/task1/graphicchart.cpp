...
{
    //В конструктор необходимо передать сколько серий
    //графиков будет использоваться. Серия это один график,
    //в одних осях может быть несколько графиков.
    numGraphs = numberGr;
 ...
 */
void GraphicChart::addDataToGraph(
        QVector<double> x, QVector<double> y, uint32_t numGraph)
{
